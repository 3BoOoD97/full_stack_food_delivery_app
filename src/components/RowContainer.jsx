...
const RowContainer = ({flag, data, scrollValue}) => {
  ...
  return (
    ...
    {data && data.map(item => (
      <div key={item.id} className='w-300 h-[225px] min-w-[300px] md:w-340 md:min-w-[340px] rounded-lg p-2 my-12
    bg-cardOverlay backdrop-blur-lg hover:drop-shadow-lg flex flex-col items-center justify-between'>
